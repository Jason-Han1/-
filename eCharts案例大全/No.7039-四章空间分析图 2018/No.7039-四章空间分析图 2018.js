...
// 先请求全国数据
var item = [
    { name: '安徽', value: '16.476' },
    { name: '北京', value: '18.889' },
    { name: '福建', value: '18.917' },
    { name: '甘肃', value: '15.5' },
    { name: '广东', value: '15.04' },
    { name: '广西', value: '18' },
    { name: '贵州', value: '17.143' },
    { name: '黑龙江', value: '16.75' },
    { name: '海南', value: '17' },
    { name: '浙江', value: '19.125' },
    { name: '河北', value: '17.938' },
    { name: '河南', value: '17.938' },
    { name: '湖北', value: '15.267' },
    { name: '湖南', value: '17.067' },
    { name: '吉林', value: '13.778' },
    { name: '江苏', value: '16.125' },
    { name: '江西', value: '19.778' },
    { name: '辽宁', value: '19.143' },
    { name: '内蒙古', value: '16.5' },
    { name: '宁夏', value: '19.25' },
    { name: '青海', value: '19.8' },
    { name: '厦门', value: '16' },
    { name: '山东', value: '16.114' },
    { name: '山西', value: '19.941' },
    { name: '陕西', value: '17.714' },
    { name: '上海', value: '14.957' },
    { name: '四川', value: '15' },
    { name: '天津', value: '17.6' },
    { name: '西藏', value: '18' },
    { name: '新疆', value: '18.154' },
    { name: '云南', value: '21.462' },
    { name: '重庆', value: '11.222' }
]

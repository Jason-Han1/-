...
var convertData = function(data) {
    ...
    for (var i = 0; i < data.length; i++) {
        ...
        var toCoord = [114.298572, 30.584355];
...
[
    ...
    series.push({
        ...
        //目的点
        {
            ...
            data: [{
                name: item[0],
                value: chinaGeoCoordMap[item[0]].concat([21365]),
            }],
        }
    );
});
...
option = {
    tooltip: {
        ...
        formatter: function(params, ticket, callback) {
            ...
            res = "<span style='color:#fff;'> 目的地：武汉"
            + "</span><br/>入汉人数：" + params.data.value[12];
            return res;
        }
    },
    title: {

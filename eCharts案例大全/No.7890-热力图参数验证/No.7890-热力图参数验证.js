...
option = {
    ...
    xAxis: {
        ...
        splitArea: {
            ...
            nameTextStyle:{
                    ...
                    lineHeight:60 ,//行高  
                    backgroundColor:'#fff', //文字背景色
                    borderColor:'#8f1fe4', //文字块边框颜色
                    borderWidth:5, //文字块边框宽度
                    borderRadius:4 ,//文字块的圆角
                    shadowColor: 'f2f2f2' //文字块的背景阴影颜色
            },
    ...
    visualMap: {
        ...
        color:['#bf444c','#2569f6', '#ffffff']  //低到高
    },
    series: [{
        name: 'Punch Card',
        type: 'heatmap',
        ...
        label: {
            ...
            color: '#512da8', // 文字颜色#e4a21f，文字随图例改变是auto，也可以自己指定
            fontSize: 15, //字体大小

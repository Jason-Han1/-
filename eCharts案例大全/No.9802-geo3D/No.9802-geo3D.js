var uploadedDataURLA = "/asset/get/s/data-1569311243409--CxGbJ0xk.json";

var uploadedDataURL = "/asset/get/s/data-1569307932533-v5DsQwFD1.json";


var routes = [];
$.getJSON(uploadedDataURLA, function(data) {
    ...
    series: [
        ...
        //柱状图
        {
            ...
            data: convertData([{
                ...
                name: "沈阳",
                value:[123.38, 41.8,200],
            }, {
                name: "昆明",
                value:  [102.73, 25.04,20],
            }, {
                name: "重庆",
                value:  [106.54, 29.59,100],
            }]),
        },
        {
            type: 'lines3D',

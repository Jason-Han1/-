...
var centerCity = {
    ...
    "银川": [106.27, 38.47],
    "海口": [110.35, 20.02],
    "台北": [121.53407, 25.091148],
    "香港": [114.173833, 22.280887],
    "澳门": [113.550614, 22.191045],
};
var nomalCity = {
    ...
    "吐鲁番": [89.1815948657, 42.9604700169],
    "和田": [79.9302386372, 37.1167744927],
    "哈密": [93.5283550928, 42.8585963324],
    "喀什": [75.9929732675, 39.4706271887],
    "塔城": [82.9748805837, 46.7586836297],
    "昌吉回族自治州": [87.2960381257, 44.0070578985],
    "自治区直辖": [85.6148993383, 42.1270009576],
    "阿克苏": [80.2698461793, 41.1717309015],
    "阿勒泰": [88.1379154871, 47.8397444862],
    ...
    "日喀则": [88.8914855677, 29.2690232039],
    "昌都": [97.18558158, 31.1405756319],
    "林芝": [94.3499854582, 29.6669406258],
    "那曲": [92.0670183689, 31.4806798301],
    "阿里": [81.1076686895, 30.4045565883],
    ...
    "海东": [102.085206987, 36.5176101677],
    ...
    "大兴安岭": [124.19610419, 51.991788968],
...
var nomalCityData = Object.getOwnPropertyNames(nomalCity).map(function(item) {
    return {
        name: item,
        value: nomalCity[item]
    };
});
var centerCityData = Object.getOwnPropertyNames(centerCity).map(function(item) {
    return {
        name: item,
        value: centerCity[item]
    };
});
...
option = {
    ...
    series: [{
        ...
        data: [{
            name: '北京>阿克苏',
            coords: [geoCoorddata['北京'], geoCoorddata['阿克苏']]
        }],
        //线上面的动态特效
        effect: {
            show: true,
        ...
        data: [{
            name: '阿克苏',
            value: geoCoorddata['阿克苏']
        }, {
            name: '深圳',
            value: geoCoorddata['深圳']
        }, {
            name: '北京',
            value: geoCoorddata['北京']
        }, {
            name: '武汉',
            value: geoCoorddata['武汉']
        }],
        itemStyle: {
            normal: {
                color: '#EE4403',

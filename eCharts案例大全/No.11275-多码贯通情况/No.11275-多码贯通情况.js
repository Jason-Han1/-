...
function dataFormatter(obj) {
    var pList = ['监测点1','监测点2','监测点3','监测点4','监测点5','监测点6','监测点7','监测点8','监测点9','监测点10','监测点11','监测点12','监测点13','监测点14','监测点15','监测点16','监测点17','监测点18','监测点19','监测点20','监测点21','监测点22','监测点23','监测点24','监测点25','监测点26','监测点27','监测点28','监测点29','监测点30','监测点31'];
    var temp;
...
dataMap.data隔离开关 = dataFormatter({
    //max : 60000,
...
option = {
    baseOption: {
        ...
        title: {
            subtext: '数据来自在线监测实时数据库'
        },
        tooltip: {
        },
        legend: {
            x: 'right',
            data: ['PH值', '水温', '溶解氧', '浊度', '电导率', 'COD'],
            selected: {
                '隔离开关': false, '开关柜': false, '断路器': false
            }
        },
        calculable : true,
        grid: {
    ...
    options: [
        {
            ...
            series: [
                ...
                {data: [
                    {name: 'PH值', value: dataMap.dataPI['2002sum']},
                    {name: '水温', value: dataMap.dataSI['2002sum']},
                    {name: '电导率', value: dataMap.dataTI['2002sum']}
                ]}
            ]
        },
        {
            ...
            series : [
                ...
                {data: [
                    {name: 'PH值', value: dataMap.dataPI['2003sum']},
                    {name: '水温', value: dataMap.dataSI['2003sum']},
                    {name: '电导率', value: dataMap.dataTI['2003sum']}
                ]}
            ]
        },
        {
            ...
            series : [
                ...
                {data: [
                    {name: 'PH值', value: dataMap.dataPI['2004sum']},
                    {name: '水温', value: dataMap.dataSI['2004sum']},
                    {name: '电导率', value: dataMap.dataTI['2004sum']}
                ]}
            ]
        },
        {
            ...
            series : [
                ...
                {data: [
                    {name: 'PH值', value: dataMap.dataPI['2005sum']},
                    {name: '水温', value: dataMap.dataSI['2005sum']},
                    {name: '电导率', value: dataMap.dataTI['2005sum']}
                ]}
            ]
        },
        {
            ...
            series : [
                ...
                {data: [
                    {name: 'PH值', value: dataMap.dataPI['2006sum']},
                    {name: '水温', value: dataMap.dataSI['2006sum']},
                    {name: '电导率', value: dataMap.dataTI['2006sum']}
                ]}
            ]
        },
        {
            ...
            series : [
                ...
                {data: [
                    {name: 'PH值', value: dataMap.dataPI['2007sum']},
                    {name: '水温', value: dataMap.dataSI['2007sum']},
                    {name: '电导率', value: dataMap.dataTI['2007sum']}
                ]}
            ]
        },
        {
            ...
            series : [
                ...
                {data: [
                    {name: 'PU值', value: dataMap.dataPI['2008sum']},
                    {name: '水温', value: dataMap.dataSI['2008sum']},
                    {name: '电导率', value: dataMap.dataTI['2008sum']}
                ]}
            ]
        },
        {
            ...
            series : [
                ...
                {data: [
                    {name: 'PH值', value: dataMap.dataPI['2009sum']},
                    {name: '水温', value: dataMap.dataSI['2009sum']},
                    {name: '电导率', value: dataMap.dataTI['2009sum']}
                ]}
            ]
        },
        {
            ...
            series : [
                ...
                {data: [
                    {name: 'PH值', value: dataMap.dataPI['2010sum']},
                    {name: '水温', value: dataMap.dataSI['2010sum']},
                    {name: '电导率', value: dataMap.dataTI['2010sum']}
                ]}
            ]
        },
        {
            ...
            series : [
                ...
                {data: [
                    {name: 'PH值', value: dataMap.dataPI['2011sum']},
                    {name: '水温', value: dataMap.dataSI['2011sum']},
                    {name: '电导率', value: dataMap.dataTI['2011sum']}
                ]}
            ]
        }
    ]

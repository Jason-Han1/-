option = {
   ...
   yAxis: {
    ...
    xAxis: [{
        ...
        data: ['职业技能培训', 'IT技能培训', 'IT技能培训', 'NODE培训', 'JAVA培训', 'JAVA培训']
    }, {
        type: 'category',
        inverse: true,
        axisTick: 'none',
        ...
        data: [50000000, 22000000, 10000000, 5000000, , 50000000, 50000000]
    }],
    series: [{
            name: '金额',
            type: 'bar',
            ...
            barWidth: 20,
            data: [50000000, 22000000, 10000000, 5000000, 100, 2000000]
        },
        {
            name: '背景',
            type: 'bar',

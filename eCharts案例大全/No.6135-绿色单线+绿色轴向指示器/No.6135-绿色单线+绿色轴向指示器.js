        ...
        axisPointer: { //轴指示器
            ...
            shadowStyle: {
                color: {
                    ...
                    colorStops: [{
                        offset: 0,
                        color: 'rgba(0,180,92,0)' // 0% 处的颜色
                    }, {
                        offset: 1,
                        color: 'rgba(0,180,92,1)' // 100% 处的颜色
                    }],
        ...
        lineStyle: {
            ...
            normal: {
                ...
                color: {
                    ...
                    colorStops: [{
                        offset: 0,
                        color: 'rgba(0,202,152, 0.9)' // 0% 处的颜色
                    }, {
                        offset: 1,
                        color: 'rgba(102,255,102, 0.9)' // 100% 处的颜色
                    }],
                    global: false // 缺省为 false
                },
                shadowColor: 'rgba(102,255,102, 1)',
                shadowBlur: 4,
                shadowOffsetY: 2
            }
        },
